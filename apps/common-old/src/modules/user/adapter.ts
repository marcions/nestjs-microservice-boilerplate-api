import { UserCreateInput, UserCreateOutput } from '@@/apps/common-old/src/core/user/use-cases/user-create';
import { UserDeleteInput, UserDeleteOutput } from '@@/apps/common-old/src/core/user/use-cases/user-delete';
import { UserGetByIDInput, UserGetByIDOutput } from '@@/apps/common-old/src/core/user/use-cases/user-getByID';
import { UserListInput, UserListOutput } from '@@/apps/common-old/src/core/user/use-cases/user-list';
import { UserUpdateInput, UserUpdateOutput } from '@@/apps/common-old/src/core/user/use-cases/user-update';
