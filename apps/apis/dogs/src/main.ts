...
import { description, name, version } from 'api/dogs/package.json';
...
async function bootstrap() {
  ...
  loggerService.log(`🔵 RabbitMQ Manager listening at ${bold(RMQ_MANAGER_URL)}\n`);
}
bootstrap();
