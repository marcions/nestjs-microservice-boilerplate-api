...
let SecretsService = exports.SecretsService = class SecretsService extends config_1.ConfigService {
    constructor() {
        super();
        ...
        this.ZIPKIN_URL = this.get('ZIPKIN_URL');
        this.PROMETHUES_URL = this.get('PROMETHUES_URL');
        this.TOKEN_EXPIRATION = this.get('TOKEN_EXPIRATION');
        this.JWT_SECRET_KEY = this.get('JWT_SECRET_KEY');
        this.RATE_LIMIT_BY_USER = this.get('RATE_LIMIT_BY_USER');
    }
};
