...
const cats_2 = require("../../infra/database/postgres/schema/cats");
...
CatsModule = __decorate([
    (0, common_1.Module)({
        imports: [auth_1.TokenModule, logger_1.LoggerModule, typeorm_1.TypeOrmModule.forFeature([cats_2.CatsSchema]), redis_1.RedisCacheModule],
        controllers: [controller_1.CatsController],
        providers: [
            {
                provide: cats_1.ICatsRepository,
                useFactory: (repository) => {
                    return new repository_1.CatsRepository(repository);
                },
                inject: [(0, typeorm_1.getRepositoryToken)(cats_2.CatsSchema)]
            },
            {
